...
add_action('wp_enqueue_scripts', function() {
    ...
    $custom_css = "
        ...
        .alchemy-booking-wizard .alc-category-heading { border-bottom: 2px solid var(--alc-head) !important; }
        ...
        .btn-book, .alc-btn-primary { 
            background: var(--alc-gold) !important; color: var(--alc-btn-text) !important; border: none !important; padding: 15px 30px !important; font-weight: 700 !important; cursor: pointer !important; display: inline-block; font-size: 16px !important; 
        }
        .alc-btn-primary:hover, .btn-book:hover, .alc-link-btn:hover { background: var(--alc-hover) !important; transform: translateY(-2px); box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
    ...
    if ($button_style === 'outline') {
        $custom_css .= ".btn-book, .alc-btn-primary { background: transparent !important; color: var(--alc-gold) !important; border: 2px solid var(--alc-gold) !important; } .btn-book:hover, .alc-btn-primary:hover { background: var(--alc-hover) !important; color: #fff !important; border-color: var(--alc-hover) !important; }";
    } elseif ($button_style === 'theme') {
        $custom_css .= ".btn-book, .btn-details { all: revert; display: inline-block; cursor: pointer; text-decoration: none; border-radius: var(--alc-radius) !important; } .btn-book { background-color: var(--alc-gold); padding: 12px 25px; font-weight: 700; color: #fff; border: none; }";
    }
    ...
    wp_localize_script('alchemy-booking-js', 'alchemyData', [
        ...
        'buttonFont' => get_option('alchemy_button_font', 'inherit'),
